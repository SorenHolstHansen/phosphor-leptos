    ...
    let body = move || {
        match weight.get() {
            IconWeight::Bold => view! {
                <path d="M176,52H80a76,76,0,0,0,0,152h96a76,76,0,0,0,0-152Zm0,128H80A52,52,0,0,1,80,76h96a52,52,0,0,1,0,104ZM80,92a36,36,0,1,0,36,36A36,36,0,0,0,80,92Zm0,48a12,12,0,1,1,12-12A12,12,0,0,1,80,140Z"></path>
            }.into_view(),
IconWeight::Duotone => view! {
    <path d="M112,128A32,32,0,1,1,80,96,32,32,0,0,1,112,128Z" opacity="0.2"></path>
...
IconWeight::Thin => view! {
    <path d="M176,60H80a68,68,0,0,0,0,136h96a68,68,0,0,0,0-136Zm0,128H80A60,60,0,0,1,80,68h96a60,60,0,0,1,0,120ZM80,92a36,36,0,1,0,36,36A36,36,0,0,0,80,92Zm0,64a28,28,0,1,1,28-28A28,28,0,0,1,80,156Z"></path>
}.into_view()
        }
    };
