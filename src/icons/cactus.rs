...
IconWeight::Fill => view! {
    <path d="M224,216a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H88V144H84A68.07,68.07,0,0,1,16,76a28,28,0,0,1,56,0A12,12,0,0,0,84,88h4V56a40,40,0,0,1,80,0v72h4a12,12,0,0,0,12-12,28,28,0,0,1,56,0,68.07,68.07,0,0,1-68,68h-4v24h48A8,8,0,0,1,224,216Z"></path>
}.into_view(),
