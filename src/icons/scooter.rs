    ...
    let body = Signal::derive(move || {
        match weight.get() {
            IconWeight::Fill => view! {
                <path d="M244,172a32,32,0,1,1-49.38-26.85l-7.35-22-45,57.8A8,8,0,0,1,136,184H73.66a32,32,0,1,1,2.08-16h56.35l49.1-63.13L162.23,48H136a8,8,0,0,1,0-16h32a8,8,0,0,1,7.59,5.47L209.8,140.08c.72-.05,1.46-.08,2.2-.08A32,32,0,0,1,244,172Z"></path>
            }.into_view(),
