...
pub fn MapPinSimple(
    ...
    let body = Signal::derive(move || {
        match weight.get() {
            IconWeight::Fill => view! { <path d="M136,127.42V232a8,8,0,0,1-16,0V127.42a56,56,0,1,1,16,0Z"></path> }.into_view(),
IconWeight::Duotone => view! {
    <path d="M176,72a48,48,0,1,1-48-48A48,48,0,0,1,176,72Z" opacity="0.2"></path>
